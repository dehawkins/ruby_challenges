# De Hawkins using the SC hint
# Reuse of a prior numerology program
puts "_____________________________________________"                                                              
puts "-"                                                                                                          
puts "-  Ruby Challenge - Numerology"                                                                             
puts "-"                                                              
puts "_____________________________________________"

# 1. Get the user's Birthday
...
# 5. use a case statement to display the correct meaning                                                          
case number
when 1                                                                                                            
...
print "What is your birthdate? Please write it like this: MMDDYYYY: "

# Use gets to assign their birthdate to a variable                                                             
birthdate = gets.chomp

# Get the Birth Date
thenumber = get_birth_number(birthdate)

# Get the message
get_message(thenumber)
